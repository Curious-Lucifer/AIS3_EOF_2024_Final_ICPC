...
MAIN_LOOP:
    cmp qword ptr [r8 + rcx * 8], r9
    jbe MAIN_LABEL1
    mov r9, qword ptr [r8 + rcx * 8]
MAIN_LABEL1:
    cmp r10, qword ptr [r8 + rcx * 8]
    jbe MAIN_LABEL2
    mov r10, qword ptr [r8 + rcx * 8]
MAIN_LABEL2:
    inc ecx
    cmp ecx, edi
    jne MAIN_LOOP
...
disable_bytes = list({255, 194, 185, 88, 2, 187, 72})
...
open('asm2.bin', 'wb').write(shellcode_asm)