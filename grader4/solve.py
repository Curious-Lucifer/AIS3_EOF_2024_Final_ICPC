...
COMPARE_STR_LOOP1:
    ...
    ja COMPARE_STR_LABEL1
    je COMPARE_STR_LABEL2

    mov eax, 2
    jmp COMPARE_STR_LABEL4
...
COMPARE_STR_LABEL2:
    test al, al
    jz COMPARE_STR_LABEL3
    inc rdi
    inc rsi
    jmp COMPARE_STR_LOOP1
...
open('asm4.bin', 'wb').write(shellcode_asm)